...
<?
/** @var \esas\cmsgate\epos\view\client\CompletionPanelEposBitrix24 $completionPanel */
$completionPanel = $params['completionPanel'];
if ($completionPanel) {
    if (array_key_exists(\esas\cmsgate\epos\ConfigFieldsEpos::instructionsSection(), $params))
        $completionPanel->setInstructionsSectionEnabled($params[\esas\cmsgate\epos\ConfigFieldsEpos::instructionsSection()]  == "Y");
    if (array_key_exists(\esas\cmsgate\epos\ConfigFieldsEpos::qrcodeSection(), $params))
        $completionPanel->setQRCodeSectionEnabled($params[\esas\cmsgate\epos\ConfigFieldsEpos::qrcodeSection()]  == "Y");
